...
//             shareUrl = `https://www.facebook.com/sharer/sharer.php?u=${encodeURIComponent(Shorten_URL)}`;
//         } else if (platform === 'whatsapp') {
//             shareUrl = `https://api.whatsapp.com/send?text=${encodeURIComponent(Shorten_URL)}`;
//         } else if (platform === 'twitter') {
//             shareUrl = `https://twitter.com/intent/tweet?url=${encodeURIComponent(Shorten_URL)}`;
//         } else if (platform === 'instagram') {
//             shareUrl = `https://www.instagram.com/?url=${encodeURIComponent(Shorten_URL)}`;
//         } else if (platform === 'linkedin') {
//             shareUrl = `https://www.linkedin.com/sharing/share-offsite/?url=${encodeURIComponent(Shorten_URL)}`;
//         } else if (platform === 'email') {
//             const subject = 'Check out this link';
//             const body = `I wanted to share this link with you: ${Shorten_URL}`;
